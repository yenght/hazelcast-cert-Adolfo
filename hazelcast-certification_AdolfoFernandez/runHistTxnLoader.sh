...
java -Xms8g -Xmx8g -XX:+UseParallelOldGC -XX:+UseParallelGC -XX:+UseCompressedOops -classpath "/home/ubuntu/hazelcast-certification_AdolfoFernandez/lib/*:/home/ubuntu/hazelcast-certification_AdolfoFernandez/target/classes/" com.hazelcast.certification.util.HistoricalTransactionRunner