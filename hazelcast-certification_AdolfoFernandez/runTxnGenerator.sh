...
java -Xms16g -Xmx16g -XX:+UseParallelOldGC -XX:+UseParallelGC -XX:+UseCompressedOops -classpath "/home/ubuntu/Certificacion/lib/*:/home/ubuntu/Certificacion/target/classes/" com.hazelcast.certification.util.TransactionsGeneratorRunner